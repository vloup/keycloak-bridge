...
func (c *authorizationComponentMW) GetStatisticsAuthentications(ctx context.Context, realm string, unit string) ([][]int64, error) {
	...
	return c.next.GetStatisticsAuthentications(ctx, realm, unit)
}
